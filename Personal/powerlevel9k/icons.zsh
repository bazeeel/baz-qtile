...
https://github.com/gabrielelana/awesome-terminal-fonts/tree/patching-strategy/patched
  ...
  'awesome-mapped-fontconfig')
    ...
    if [ -z "$AWESOME_GLYPHS_LOADED" ]; then
        echo "Powerlevel9k warning: Awesome-Font mappings have not been 
loaded.
        Source a font mapping in your shell config, per the Awesome-Font 
docs
        (https://github.com/gabrielelana/awesome-terminal-fonts),
...
# 
      TODO_ICON                      
'\u'$CODEPOINT_OF_AWESOME_CHECK_SQUARE_O       # 
      BATTERY_ICON                   
...
# 
      HOME_SUB_ICON                  
'\u'$CODEPOINT_OF_AWESOME_FOLDER_OPEN          # 
...
# 
      VCS_UNTRACKED_ICON             
'\u'$CODEPOINT_OF_AWESOME_QUESTION_CIRCLE      # 
      VCS_UNSTAGED_ICON              
...
# 
      VCS_INCOMING_CHANGES_ICON      
'\u'$CODEPOINT_OF_AWESOME_ARROW_CIRCLE_DOWN' ' # 
      VCS_OUTGOING_CHANGES_ICON      
...
# 
      VCS_COMMIT_ICON                
'\u'$CODEPOINT_OF_OCTICONS_GIT_COMMIT' '       # 
      VCS_BRANCH_ICON                
'\u'$CODEPOINT_OF_OCTICONS_GIT_BRANCH' '       # 
      VCS_REMOTE_BRANCH_ICON         
'\u'$CODEPOINT_OF_OCTICONS_REPO_PUSH           # 
      VCS_GIT_ICON                   '\u'$CODEPOINT_OF_AWESOME_GIT' '               
# 
      VCS_GIT_GITHUB_ICON            
'\u'$CODEPOINT_OF_AWESOME_GITHUB_ALT' '        # 
      VCS_GIT_BITBUCKET_ICON         
'\u'$CODEPOINT_OF_AWESOME_BITBUCKET' '         # 
...
# 
      EXECUTION_TIME_ICON            
'\u'$CODEPOINT_OF_AWESOME_HOURGLASS_END        # 
      SSH_ICON                       '(ssh)'
